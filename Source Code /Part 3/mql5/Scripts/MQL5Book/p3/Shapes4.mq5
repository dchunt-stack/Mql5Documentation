...
public:
   ...
   /* virtual */ // for 'covariant return type' example
...
public:
   ...
   // 'covariant return type' example: Shape -> Rectangle
   /*
   Rectangle *setColor(const color c) override
   {
   ...
   */
   ...
   // error example:
   // 'Rectangle::next' method is declared with 'override' specifier,
